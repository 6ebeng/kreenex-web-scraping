...
// YOU NEED TO SET this._settings.device.userAgent AND this._settings.vendor
this._settings.device.userAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Safari/537.36"
this._settings.vendor = "Intel Inc."
...
if (!this._WebGL) {
    ...
    if (machine.os.name.toLowerCase().includes('windows')) {
        ...
        this._WebGL['s37445'] = this._settings.vendor;
